...
import com.harrymin.common.exception.file.FileSizeLimitExceededException;
import com.harrymin.common.exception.file.InvalidExtensionException;
...
public class FileUploadUtils {
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = HarryMinConfig.getProfile();
    ...
    public static final String getPathFileName(String uploadDir, String fileName) throws IOException {
        int dirLastIndex = HarryMinConfig.getProfile().length() + 1;
