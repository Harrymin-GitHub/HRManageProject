  ...
  <div class="app-container home">
    ...
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        <h2>HR后台管理框架</h2>
        <p>
          一款后台管理系统，可以用于所有的Web应用程序，如网站管理后台，网站会员中心，CMS，CRM，OA等等，可以进行深度定制，以做出更强系统。同时支持移动客户端访问。
        </p>
        <p>
        ...
        <p>
          <el-button
            ...
            icon="el-icon-cloudy"
            plain
            @click="goTarget('https://github.com/Harrymin-GitHub/HRManageProject.git')"
          >访问码云
          </el-button
          >
        </p>
        ...
        <el-card class="update-log">
          ...
          <div class="body">
            <p>
              ...
              <el-link
                href="https://github.com/Harrymin-GitHub/HRManageProject"
                target="_blank"
              >https://github.com/Harrymin-GitHub/HRManageProject
              </el-link
              >
            </p>
            <p>
              <i class="el-icon-user-solid"></i> QQ群：780664392
            </p>
            <p>
              <i class="el-icon-chat-dot-round"></i> 微信：<a href="javascript:;">MinHR_12138</a>
            </p>
          </div>
        </el-card>
      </el-col>
      <el-col :xs="24" :sm="24" :md="12" :lg="8">
        <el-card class="update-log">
          ...
          <el-collapse accordion>
            <el-collapse-item title="v3.9.0 - 2024-04-30">
              <ol>
                <li>新增员工管理</li>
                <li>新增项目管理</li>
              </ol>
      ...
      <el-col :xs="24" :sm="24" :md="12" :lg="8">
        <el-card class="update-log">
          ...
          <div class="body">
            ...
            />
            <img
              src="../assets/images/wechartPay.png"
              alt="donate"
              width="50%"
            />
